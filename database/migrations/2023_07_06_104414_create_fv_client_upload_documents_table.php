...
class CreateFvClientUploadDocumentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fv_client_upload_documents', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fv_client_upload_documents');
    }
}
