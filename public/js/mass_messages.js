...
$("body").on("click", "button.mass-messages-edit", async function () {
    let json_details = $(this).data('json');
    $('input[name="mass_messages_id"]').val(json_details.id);
    $('textarea[name="update_message_body"]').val(json_details.message_body);
});
